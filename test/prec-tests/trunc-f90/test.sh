...
RAPTOR_BUILD_DIR="/scratch/fhrold/reproducibility/Raptor/raptor/build"

cp /scratch/fhrold/reproducibility/Raptor/raptor/include/raptor/fprt/mpfr.h "./mpfr.cpp"
clang++ -c "./mpfr.cpp" $(pkg-config --cflags mpfr gmp) \
    -I/scratch/fhrold/reproducibility/Raptor/raptor/include/raptor/fprt/ \
...
mpif90 -O2 mpfr.o simple_math.o main_patch.o -o ./main-flang \
    ...
    -Wl,-mllvm -Wl,-load=${RAPTOR_BUILD_DIR}/Raptor/LLDRaptor-20.so \
