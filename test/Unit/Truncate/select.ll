...
; CHECK: define internal double @__raptor_done_truncate_mem_func_ieee_64to32_23_f(double %x, double %y, i1 %cond) {
; CHECK-NEXT:   %res = select i1 %cond, double %x, double %y
; CHECK-NEXT:   ret double %res
; CHECK-NEXT: }

; CHECK: define internal double @__raptor_done_truncate_op_func_ieee_64to32_23_f(double %x, double %y, i1 %cond) {
; CHECK-NEXT:   %res = select i1 %cond, double %x, double %y
; CHECK-NEXT:   ret double %res
; CHECK-NEXT: }
