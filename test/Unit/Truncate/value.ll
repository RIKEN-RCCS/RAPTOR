...
; CHECK-NEXT: entry:
; CHECK-NEXT:   %0 = call double @__raptor_fprt_64_52_get(double %a, i64 8, i64 23, i64 1, {{.*}}i8{{.*}})
; CHECK-NEXT:   ret double %0

; CHECK: define double @truncate_tester(double %a) {
; CHECK-NEXT: entry:
; CHECK-NEXT:   %0 = call double @__raptor_fprt_64_52_new(double %a, i64 8, i64 23, i64 1, {{.*}}i8{{.*}})
; CHECK-NEXT:   ret double %0
